...
const LearnTab = () => {
  return (
    <>
      <div className="ttt overflow overflow-y-auto border-l-2 border-[#bababa5e] pt-24 bg-black text-white text-4xl text-center min-h-screen max-h-screen font-mono">
      Learn
      {/* <div className=" overflow flex justify-center items-center v-screen overflow-y-auto">
          <div className=" flex flex-col border p-4 mt-6 w-5/6 float-left bg-white rounded-xl text-black">
             <div className=" float-left ml-3 text-2xl font-sans font-semibold">What is block chain?</div>
             <div className=" text-sm mt-1"><p></p>A blockchain is a distributed database or ledger shared among a computer network's nodes. 
      ...
      <div className=" overflow flex justify-center items-center v-screen overflow-y-auto">
          <div className=" flex flex-col border p-4 mt-8 w-5/6 float-left bg-white rounded-xl text-black">
             <div className=" float-left ml-3 text-2xl font-sans font-semibold">Social Media DApp</div>
             <div className="  text-sm mt-1"><p></p>A decentralized application (DApp) is a type of distributed, open source software application 
      ...
      <div className=" overflow flex justify-center items-center v-screen overflow-y-auto">
          <div className=" flex flex-col border p-4 mt-8 w-5/6 float-left bg-white rounded-xl text-black">
             <div className=" float-left ml-3 text-2xl font-sans font-semibold">About NFTs</div>
             <div className="  text-sm mt-1"><p></p>NFTs are one-of-a-kind digital assets held on a blockchain. 
